    ...
    <div className="main_div2">
        ...
        <div className="card">
            ...
            <div className="text2">
                ...
                <h4>Phone: +324 123 45 978 <br/> Email: <a className="support" href="">support@habikon.com</a> </h4>
        ...
        <div className="card">
            ...
            <div className="text2">
                ...
                <h4>Flat A, 20/7, Reynolds Neck Str <br/> Helenaville, FV77 8WS</h4>
        ...
        <div className="card">
            ...
            <div className="text2">
                ...
                <h4>Mon - Satday: 9.00am to 6.00pm <br/> Sunday: Holiday</h4>
